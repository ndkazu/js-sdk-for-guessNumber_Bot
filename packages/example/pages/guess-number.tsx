                ...
                .then((data) => {
                    ...
                    if (ok) {
                        ...
                        if (guessResult === 'Correct') {
                            ...
                            setNumber('')
                        } else if (guessResult === 'BotWin') {
                            toaster.negative('Bot win!', {})
                            setNumber('')} else {
    ...
    const sC0 = useCallback(() => {
        ...
        phala
            ...
            .then((data) => {
                ...
                if (ok) {
                    const result = ok.score0
                    toaster.update(toastKey, {
                        children: `Your Score is ${result}`,
                        autoHideDuration: 3000,
                    })
                }
    ...
    const sC1 = useCallback(() => {
        ...
        phala
            ...
            .then((data) => {
                ...
                if (ok) {
                    const result = ok.score1
                    toaster.update(toastKey, {
                        children: `Bot's Score is ${result}`,
                        autoHideDuration: 3000,
                    })
                }
            ...
            <Step title="Play">
                <div>
                    <form onSubmit={onGuess}>
                        <FormControl
                            label="Guess Number"
                            caption="i32 from 0 to 2,147,483,647"
                        >
                            <Input
                                autoFocus
                                type="number"
                    ...
                    >
                        ...
                        <Button onClick={sC0}>Query Your Score</Button>
                        <Button onClick={sC1}>Query Bot's Score</Button>
    ...
    useEffect(() => {
        createApi({
            ...
            types: {
                ...
                GuessResult: {
                    _enum: ['TooLarge', 'ToSmall', 'Correct','BotWin'],
                },
                GuessError: {
                    _enum: ['OriginUnavailable', 'NotAuthorized'],
                },
                GuessNumberRequestData: {
                    _enum: { QueryOwner: null, Guess: 'Guess', PeekRandomNumber: null, QueryScore0: null, QueryScore1: null },
                },
